...
vi.mock('@/_backend/modules/core/helpers/setup-valid.helper', () => ({
    setupVapid: setupVapidMock,
}))
vi.mock('@/_backend/modules/core/repositories/push-subscriptions.repository', () => ({
    selectPushSubscriptions: selectSubscriptionsMock,
}))
vi.mock('@/_backend/modules/core/processors/send-to-subscriptions.processor', () => ({
