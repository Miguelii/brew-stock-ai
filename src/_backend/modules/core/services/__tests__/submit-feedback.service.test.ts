...
import { submitFeedback } from '@/_backend/modules/core/services/submit-feedback.service'
...
vi.mock('@/_backend/modules/auth/services/get-session.service', () => ({
    getSession: getSessionMock,
}))
vi.mock('@/_backend/modules/core/repositories/feedback.repository', () => ({
