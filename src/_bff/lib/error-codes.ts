export enum ErrorCode {
    ...
    CHECKOUT_NO_STRIPE_SECRET_KEY = 'a28nsk2',
    CHECKOUT_NO_STRIPE_WEBHOOK_KEY = 'n9sj71p',
    ...
    INVOICES_NO_STRIPE_SECRET_KEY = 'h2ks82n',
    ...
    ADMIN_USER_CREDITS_FETCH = 'admn_ucfch',
    ADMIN_USER_CREDITS_FETCH_ERR = 'admn_ucerr',
