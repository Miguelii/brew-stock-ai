...
import { getLatestNews } from '@/_bff/modules/finnhub/services/get-latest-news-cached.service'
...
vi.mock('@/_bff/modules/finnhub/processors/fetch-latest-news.processor', () => ({
