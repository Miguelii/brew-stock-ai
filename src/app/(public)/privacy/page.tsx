...
import { PRIVACY_PAGE_LAST_UPDATE_AT } from '@/lib/constants'
...
const META_DESCRIPTION =
    "Read BrewStockAI's Privacy Notice to understand how we collect, use, and protect your personal data. GDPR-compliant. We never sell your data to third parties."
...
const LAST_UPDATE_AT_DATE = new Date(PRIVACY_PAGE_LAST_UPDATE_AT).toLocaleDateString()
            ...
            <main id="main" className="main-container">
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Last updated: {LAST_UPDATE_AT_DATE}
                    </p>
                </div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">
                    ...
                    <strong className="text-foreground">BrewStockAI</strong> collects, uses, and
                    protects your personal data when you use our service. By using BrewStockAI, you
                ...
                <div className="space-y-7">
                    ...
                    <Section title="2. How We Use Your Data">
                        <p>
                            We use your data solely to provide and improve the BrewStockAI service:
                        </p>
                        <ul className="list-disc list-inside space-y-1 pl-1">
                    ...
                    <Section title="6. Disclaimer">
                        <p>
                            All analysis reports generated by BrewStockAI are produced by an AI
                            model and are for
