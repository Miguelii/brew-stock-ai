...
import { CreateSbClientError, GetInvoicesError } from '@/backend/lib/errors'
...
const getInvoices = Effect.fn('getInvoices')(function* (user: User) {
...
export const GET_INVOICES_PROTECTED_PROCEDURE = protectedProcedure.query(({ ctx }) =>
