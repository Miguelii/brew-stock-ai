...
import { CreateSbClientError, ExportReportError } from '@/backend/lib/errors'
import { ErrorCode } from '@/backend/lib/error-codes'
import type { ReportDTO, StockData } from '@/types/ReportDTO'
import type { User } from '@supabase/supabase-js'
import { ClientEnv } from '@/env/client'
import { buildPdfHtml } from '../helpers/build-pdf-html.helper'
...
const exportReport = Effect.fn('exportReport')(function* (user: User, id: ReportDTO['id']) {
...
export const EXPORT_REPORT_PROTECTED_PROCEDURE = protectedProcedure
