...
vi.mock('@/backend/modules/analysis/processors/get-stock-analysis.processor', () => ({
    getStockAnalysis: getStockAnalysisMock,
}))
vi.mock('@/backend/modules/core/processors/send-push-notification-to-user.processor', () => ({
