...
export function AccountInvoicesTable() {
    ...
    return (
        <div className="divide-y divide-border rounded-none border border-border overflow-hidden">
            <div className="grid grid-cols-[1fr_auto_auto] gap-4 px-4 py-2.5 bg-muted text-xs font-semibold uppercase tracking-widest text-muted-foreground">
            ...
            {invoices.map((invoice) => (
                <div
                    key={invoice.id}
                    className="grid grid-cols-[1fr_auto_auto] gap-4 px-4 py-3 text-sm items-center hover:bg-muted/50 transition-colors"
                >
