...
export const DIVIDEND_GROWTH_INVESTING_ARTICLE: EducationHubArticle = {
    slug: 'dividend-growth-investing',
    title: 'Dividend Growth Investing: Why a Rising 2% Beats a Static 6%',
    description:
