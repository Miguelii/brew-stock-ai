...
export const EMERGENCY_FUND_BEFORE_INVESTING_ARTICLE: EducationHubArticle = {
    slug: 'emergency-fund-before-investing',
    title: 'The Emergency Fund Question: How Much Cash Before You Invest?',
    description:
