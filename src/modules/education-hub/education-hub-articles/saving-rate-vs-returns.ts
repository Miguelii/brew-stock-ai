...
export const SAVING_RATE_VS_RETURNS_ARTICLE: EducationHubArticle = {
    slug: 'saving-rate-vs-returns',
    title: 'Savings Rate vs. Investment Returns: Which Matters More Early On?',
    description:
