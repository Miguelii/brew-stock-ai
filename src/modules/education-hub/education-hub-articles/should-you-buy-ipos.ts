...
export const SHOULD_YOU_BUY_IPOS_ARTICLE: EducationHubArticle = {
    slug: 'should-you-buy-ipos',
    title: 'Should You Buy an IPO? What the First-Year Numbers Say',
    description:
